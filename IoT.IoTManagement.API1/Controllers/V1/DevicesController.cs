...
{
    /// <summary>
    /// Controller containing device management related feaures (create, get, update, delete) and device properties oriented endpoints.
    /// </summary>
    [ApiController]
    [ApiVersion("1.0")]
    ...
    public class DevicesController : Controller
    {
        ...
        [HttpGet()]
        [Route("{maxCount:int?}")]
        public async Task<IEnumerable<JObject>> GetDevicesAsync(int maxCount = 100)
        {
        ...
        public async Task<Device> AddDevice([FromBody]ProvisionDeviceRequest value)
        {
            ...
            var data = await _provisioningService.AddDeviceAsync(value.DeviceId, Mapper.Map<SIoT.DeviceIoTSettings>(value.DeviceIoTSettings));
